...
while len(nome) <= 3:
    print(f'nome deve ter mais de 3 letras:')
    nome = input("digite seu nome: ")

idade = int(input(f"{nome} digite sua idade: "))
while 0 > idade or 150 < idade:
    print(f'Idade deve estar entre 0 e 150')
    idade = int(input(f"{nome} digite sua idade: "))
